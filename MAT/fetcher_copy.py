...
def fetch_pubmed(ids):
    ...
    for article in root.findall(".//PubmedArticle"):
        ...
        if authors_elem is not None:
            authors = [
                f"{author.findtext('.//LastName') or author.findtext('.//CollectiveName') or 'porcodio'} {author.findtext('.//ForeName') or author.findtext('.//CollectiveName') or 'porcodio'}"
...
print(unique_df)
unique_df.to_json("pubmed_data_1.json", orient="records", lines=True)
